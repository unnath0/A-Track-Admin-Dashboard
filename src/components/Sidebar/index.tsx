...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const handleDeptClick = async (dept: string | null, empId: number | null) => {
  ...
  const handleEmployeesClick = (dept: string | null) => {
    ...
    if (currentUserDetail) {
      ...
      if (
          ...
          >
            <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
              ...
              {departments.map((dept) => (
                <li key={dept} onClick={() => handleDeptClick(dept, null)}>
                  <div className="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white hover:cursor-default">
                    {dept}
                  </div>
                </li>
              ))}
              <li onClick={() => handleEmployeesClick(null)}>
                <div className="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white hover:cursor-default">
                  Employees
                </div>
              </li>
          ...
          >
            <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
              <li
                ...
                onClick={() => handleDeptClick(currentUserDetail.dept, null)}
              >
                <div className="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white hover:cursor-default">
                  {currentUserDetail.dept}
                </div>
              </li>
              <li onClick={() => handleEmployeesClick(currentUserDetail.dept)}>
                <div className="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white hover:cursor-default">
                  Employees
                </div>
              </li>
        ...
        content = (
          ...
          >
            <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
              <li onClick={() => handleEmployeesClick(currentUserDetail.empId)}>
                <NavLink
                  to="/"
                  className={({ isActive }) =>
                    'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white hover:cursor-default' +
